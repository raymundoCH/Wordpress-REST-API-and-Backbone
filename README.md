...
- Some local web server. In my case the PHP web dev server was implemented.

## Instructions

Once you have cloned the repository navigate to the root folder of the project with the console and run the next command:
